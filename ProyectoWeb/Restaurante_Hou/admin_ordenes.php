                ...
                <tr>
                    ...
                    <td>
                        <?php if ($estado === 'pendiente'): ?>
                            <a href="admin_ordenes.php?id_sucursal=<?= $id_sucursal ?>&completar_orden=<?= $o['num_orden'] ?>"
                               class="btn-modificar"
                               onclick="return confirm('¿Seguro que deseas marcar la orden #<?= $o['num_orden'] ?> como completada?');">
                               Completar
                            </a>
                            <a href="admin_ordenes.php?id_sucursal=<?= $id_sucursal ?>&cancelar_orden=<?= $o['num_orden'] ?>"
                               class="btn-eliminar"
                               onclick="return confirm('¿Seguro que deseas cancelar la orden #<?= $o['num_orden'] ?>?');">
                               Cancelar
                            </a>
                        <?php else: ?>
                            <em>Sin acciones</em>
